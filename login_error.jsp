		...
		<div class="main">
			<div class="container">
				<div class="row">
					<form>
						<div class="col-xs-12 col-md-12">
							<input id="comment" type="text" name="username" style="color:#ff0000" 
								placeholder="Daten sind falsch! Benutzernamen erneut eingeben!"><input id="comment"
								type="password" name="password" style="color:#ff0000" placeholder="Daten sind falsch! Passwort erneut eingeben!">
